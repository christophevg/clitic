  ...
  async def test_auto_scroll_true_at_bottom(self) -> None:
    ...
    async with ConversationTestApp().run_test() as pilot:
      ...
      if max_y > 0:
        ...
        assert conv.auto_scroll is True, f"Expected auto_scroll=True at bottom (scroll_y={conv.scroll_y}, max_y={max_y})"
  ...
  async def test_scroll_near_bottom_threshold(self) -> None:
    ...
    async with ConversationTestApp().run_test() as pilot:
      ...
      if max_y > 1:
        ...
        conv._update_auto_scroll_from_scroll_position()
        assert conv.auto_scroll is True, f"auto_scroll should be True at bottom (scroll_y={conv.scroll_y}, max_y={max_y})"
...
class TestResizeBehavior:
  ...
  async def test_resize_at_bottom_preserves_auto_scroll(self) -> None:
    ...
    async with ConversationTestApp().run_test() as pilot:
      ...
      if max_y > 0:
        ...
        assert conv.auto_scroll == initial_auto_scroll, f"auto_scroll should remain {initial_auto_scroll} after resize"
  ...
  async def test_resize_calls_update_auto_scroll(self) -> None:
    ...
    async with ConversationTestApp().run_test() as pilot:
      ...
      assert len(update_called) > 0, "_update_auto_scroll_from_scroll_position should be called"
...
class TestVisualFeedback:
  ...
  async def test_paused_class_removed_at_bottom(self) -> None:
    ...
    async with ConversationTestApp().run_test() as pilot:
      ...
      assert conv.auto_scroll is True, f"auto_scroll should be True at bottom (scroll_y={conv.scroll_y}, max_y={conv.max_scroll_y})"
    ...
    async with ConversationTestApp().run_test() as pilot:
      ...
      if max_y > 1:
        ...
        if conv.scroll_y >= max_y - 1:
          assert conv.auto_scroll is True, f"auto_scroll should be True near bottom (scroll_y={conv.scroll_y}, max_y={max_y})"
  ...
  async def test_scroll_position_preserved_after_resize_at_bottom(
    ...
    async with ConversationTestApp().run_test() as pilot:
      ...
      if conv.max_scroll_y > 0:
        ...
        assert conv.auto_scroll is True, "auto_scroll should remain True after resize at bottom"
