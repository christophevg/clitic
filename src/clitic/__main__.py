...
def main() -> None:
  ...
  print("  [x] Package structure")
  print("  [x] Version information")
  print("  [x] Executable module")
  print("  [x] Core App class with plugin management")
  print("  [x] on_submit decorator for input handling")
  print()
